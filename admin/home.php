<h1>Dobrodošli na <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
        <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ukupno kategorija</span>
          ...
          <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ukupno polja</span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ukupno uređaja</span>
                <span class="info-box-number">
                  <?php 
