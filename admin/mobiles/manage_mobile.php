...
<div class="content py-3">
    <div class="card card-outline card-purple rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title"><b><?= isset($id) ? "Ažuriraj podatke o uređaju" : "Dodaj novi uređaj" ?></b></h4>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <form action="" id="mobile-form">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="display_content" class="control-label">Prikaz sadržaja</label>
                                <textarea cols="3" name="display_content" id="display_content" class="form-control form-control-sm rounded-0 summernote"><?php echo isset($display_content) ? $display_content : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
                            ...
                            ?>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea cols="3" name="field_id[<?= $frow['id'] ?>]" id="field_id_<?= $frow['id'] ?>" class="form-control form-control-sm rounded-0"><?php echo isset($field[$frow['id']]) ? $field[$frow['id']] : ''; ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="control-label">Ostale slike</label>
                                ...
                                <label class="custom-file-label" for="customFile" style="white-space: nowrap;">Odaberite datoteku</label>
                                </div>
                                <small><i>Odaberite za prijenos novih slika</i></small>
                            </div>
                            <?php 
                            if(isset($id)):
        ...
        <div class="card-footer text-right">
                <button class="btn btn-sm btn-flat btn-primary" type="submit" form="mobile-form">Spremi</button>
                <a class="btn btn-sm btn-flat btn-default border" hraf="./?page=mobiles">Odustani</a>
        </div>
    </div>
</div>
