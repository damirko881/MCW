...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title">Detalji uređaja</h4>
            <div class="card-tools">
                <a href="./?page=mobiles/manage_mobile&id=<?= isset($id) ? $id : '' ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-edit"></i> Uredi detalje</a>
                <button id="delete_mobile" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i> Izbriši podatke</button>
            </div>
        </div>
        <div class="card-body">
            <div class="row gx-4 gx-lg-5 align-items-top">
                ...
                <div class="col-md-6">
                    ...
                    <p class="m-0"><span class="text-muted">Marka: </span><div class="h4 font-weight-bolder w-auto"><?= isset($brand) ? $brand : "" ?></div></p>
                    <div>
