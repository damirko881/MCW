...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="manage_order" class="btn btn-flat btn-sm btn-navy border"><span class="fas fa-stream"></span>  Ažuriraj redosljed</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Jeste li sigurni da želite trajno izbrisati ovu kategoriju?","delete_category",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Nova kategorija","categories/manage_category.php")
		})
		$('#manage_order').click(function(){
			uni_modal("<i class='fa fa-strem'></i> Uredite redosljed kategorija","categories/manage_order.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-eye'></i> Detalji kategorije","categories/view_category.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Ažurirajte kategoriju","categories/manage_category.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
