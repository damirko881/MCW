            ...
            <div class="container px-4 px-lg-5 mt-5">
                <form action="" id="compare-frm">
                    <div class="card card-outline card-purple rounded-0 shadow">
                        <div class="card-body">
                            <fieldset>
                                <legend>Usporedite mobitele</legend>
                                <div class="row align-items-end">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="mobile1" class="control-label">Mobitel 1</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="mobile2" class="control-label">Mobitel 2</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <button class="btn btn-default bg-gradient-purple btn-flat text-light">Usporedba</button>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
    ...
    $(function(){
        ...
        $('#compare-frm').submit(function(e){
            ...
            if($('#mobile1').val() == $('#mobile2').val()){
                alert_toast(" Odabrani uređaji za usporedbu su isti",'warning')
                return false;
            }
