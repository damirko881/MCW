        ...
        <div class="col-lg-12 py-2">
            ...
            <div class="container px-4 px-lg-5 mt-5">
                        ...
                        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="search" class="form-control form-control-lg" name="search" value="<?= isset($_GET['search']) ? $_GET['search'] : "" ?>" placeholder="Pretražite mobitele...">
                    ...
                    <div class="col mb-5">
                        <a class="card product-item text-reset text-decoration-none" href=".?p=view_content&id=<?php echo ($row['id']) ?>">
                            ...
                            <div class="card-body p-4">
                                ...
                                <p class="m-0"><span class="text-muted">Marka: </span><?= isset($row['brand']) ? ($row['brand']) : "" ?></small></p>
                            </div>
                        </a>
                    </div>
                    <?php endwhile; ?>
                ...
                <?php if($qry->num_rows < 1): ?>
                    <center><em class="text-muted">Nema rezultata.</em></center>
                <?php endif; ?>
            </div>
    </div>
    </div>
